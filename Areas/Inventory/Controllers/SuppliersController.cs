...
namespace iSynergy.Areas.Inventory.Controllers
{
    public class SuppliersController : CustomController
    {
        ...
        public ActionResult Create([Bind(Include = "SupplierId,Name,Address,LandLine,Mobile,Email")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupplierId,Name,Address,LandLine,Mobile,Email")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
